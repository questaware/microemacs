...
#else
#define lforw(lp)	((struct LINE *)(lp)->l_fp)
#define lback(lp)	((struct LINE *)(lp)->l_bp)
#define Lineptr		Int          
#endif
...
union EPOINTER {
	int (Pascal NEAR *fp)(int, int);/* C routine to invoke */
...
typedef int (Pascal NEAR *Pfunc)();	/* function name is bound to */
