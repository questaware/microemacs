...
#define	TEXT52	"%%%pNo such variable as '%s'%w"
#define	TEXT53	"Value: "
...
#define	TEXT74	"%%buffer is not narrowed"
...
#define	TEXT156	"Closing file: Error"
#define	TEXT156a "Error"
